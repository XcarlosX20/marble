...
const Whyus = () => {
    const qualities = [
        {icon: beauty, title: 'Beauty', bodyContent: 'Elevating spaces with the beauty of natural stone.'},
        {icon: quality, title: 'Quality', bodyContent: 'Elevate your living experience with the best  marble.'},
        {icon: excellence, title: 'Excellence', bodyContent: 'Excellence in marble craftsmanship.'},
        {icon: style, title: 'style', bodyContent: 'The art of marble: Timeless, luxurious, and functional.'}
    ]
    return ( 
    <>
    <section style={{backgroundImage: 'url(https://res.cloudinary.com/do5yybhwe/image/upload/v1682628836/bgwhyus-min_jnymc8.jpg)'}}
        className="bg-cover bg-fixed h-full md:h-[100vh] text-fontWhite pt-16">
            <h2 className='text-center uppercase text-3xl font-bold'>Why us</h2>
            <div className="px-18 py-16 mx-8 md:mx-48 flex flex-col gap-8 md:flex-row">
                ...
                <div className='grid grid-cols-1 grid-rows-4 md:grid-cols-2 md:grid-rows-4 gap-y-16 md:w-8/12'>
