  ...
  return (
    <>
      <div
        ...
        className={styles["btn-burguer-container"]}
      >
        <div className={styles["btn-burguer"]}></div>
      </div>
      <div
        className={`${styles["cont-main"]} ${
          !openMenuMobile ? `${styles["transition-entrance"]}` : ""
        } bg-light-300`}
      >
          ...
          <div className="flex h-[80vh]">
            <div className="w-3/12">
              <div className="h-full flex-col justify-start">
                <button className="ml-4 mt-2" onClick={toggleMenuMobile}>
                  <Image width={19} src={arrowLeft} alt="arrow left" />
                </button>
              </div>
            </div>
